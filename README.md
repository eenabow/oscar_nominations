...
* Created supervised learning models using [logistic classification](ML_tests), random forest and XGBoost (decision trees) to produce the highest accuracy rating.
